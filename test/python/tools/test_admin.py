...
def test_analyse_indexing_with_osm_id(project_env, temp_db_cursor):
    temp_db_cursor.execute(
        """INSERT INTO placex (place_id, osm_type, osm_id)
                              VALUES(9988, 'N', 10000)"""
    )
...
class TestAdminCleanDeleted:
    ...
    def setup_polygon_delete(
        ...
        temp_db_cursor.execute(
            """INSERT INTO placex (place_id, osm_id, osm_type, class, type, indexed_date, indexed_status)
    ...
    def test_admin_clean_deleted_no_records(self):
        ...
        assert self.temp_db_cursor.row_set(
            "SELECT osm_id, osm_type, class, type, indexed_status FROM placex"
        ) == {
            (100, "N", "boundary", "administrative", 1),
    ...
    def test_admin_clean_deleted(self, test_age):
        ...
        assert self.temp_db_cursor.row_set(
            ...
            (100, "N", "boundary", "administrative", 100),
            (145, "N", "boundary", "administrative", 100),
            (175, "R", "landcover", "grass", 100),
        }
