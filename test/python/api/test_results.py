...
def test_minimal_detailed_result():
    res = DetailedResult(SourceTable.PLACEX, ("amenity", "post_box"), Point(23.1, 0.5))
...
def test_detailed_result_custom_importance():
    res = DetailedResult(
        SourceTable.PLACEX, ("amenity", "post_box"), Point(23.1, 0.5), importance=0.4563
    )
...
@pytest.mark.parametrize(
    "func",
    (
        nresults.create_from_placex_row,
