...
@pytest.mark.parametrize(
    "lop,rop", [((1, 2), (3, 4)), ((3, 4), (3, 5)), ((10, 12), (11, 12))]
)
...
def test_token_range_lt():
    ...
    assert nq.TokenRange(5, 6) >= nq.TokenRange(5, 6)
    assert nq.TokenRange(10, 11) >= nq.TokenRange(4, 5)
...
def test_token_rankge_gt():
    ...
    assert nq.TokenRange(5, 6) <= nq.TokenRange(5, 6)
    assert nq.TokenRange(1, 2) <= nq.TokenRange(3, 4)
    assert nq.TokenRange(4, 10) <= nq.TokenRange(3, 5)
