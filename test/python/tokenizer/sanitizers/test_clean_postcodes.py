...
def sanitize(def_config, request):
    ...
    def _run(country=None, **kwargs):
        ...
        _, address = PlaceSanitizer([sanitizer_args], def_config).process_names(
            PlaceInfo(pi)
        )
...
@pytest.mark.parametrize(
    "postcode", ("12345", "  12345  ", "de 12345", "DE12345", "DE 12345", "DE-12345")
)
...
@pytest.mark.parametrize(
    "postcode", ("123456", "", "   ", ".....", "DE  12345", "DEF12345", "CH 12345")
)
@pytest.mark.sanitizer_params(convert_to_address=False)
...
@pytest.mark.parametrize(
    "postcode", ("KY-1234", "KZ1-1234", "KY1 1234", "KY1-123", "KY KY1-1234")
)
@pytest.mark.sanitizer_params(convert_to_address=False)
...
@pytest.mark.parametrize(
    "postcode", ("MTF 1111", "MT MTF 1111", "MTF1111", "MT MTF1111")
)
...
@pytest.mark.parametrize(
    "postcode", ("C", "12", "ABC123DEF 456", "1234,5678", "11223;11224")
)
@pytest.mark.sanitizer_params(
    convert_to_address=False, default_pattern="[A-Z0-9- ]{3,12}"
)
