...
class TestGetReplacements:
    ...
    @pytest.mark.parametrize(
        "variant", ["foo > bar", "foo -> bar -> bar", "~foo~ -> bar", "fo~ o -> bar"]
    )
    ...
    def test_add_suffix_no_decompose(self):
        ...
        assert repl == [(" berg ", [" berg", " bg"]), ("berg ", ["berg", "bg"])]
    ...
    def test_replace_suffix_decompose(self):
        ...
        assert repl == [(" berg ", [" bg", "bg"]), ("berg ", [" bg", "bg"])]
    ...
    def test_replace_prefix_compose(self):
        ...
        assert repl == [(" hinter", [" h", " h "]), (" hinter ", [" h", " h"])]
    ...
    def test_decompose_only(self):
        ...
        assert repl == [(" foo ", [" foo", "foo"]), ("foo ", [" foo", "foo"])]
